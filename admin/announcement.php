...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    <head>
        ...
        <title>Online Library Management System | Manage Announcements</title>
                                        ...
                                        {               ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a href="edit-announcement.php?announcement_id=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button>
                                                        <a href="announcement.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                                </td>
                                            </tr>
                                            <?php $cnt=$cnt+1;}} ?>
                                    </tbody>

...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2023 at 10:37 PM
...
--
-- Table structure for table `tbannouncements`
--

CREATE TABLE `tbannouncements` (
  `id` int(11) NOT NULL,
  `announcement_title` varchar(250) NOT NULL,
  `annoucement_body` text DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `created_at` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbannouncements`
--

INSERT INTO `tbannouncements` (`id`, `announcement_title`, `annoucement_body`, `status`, `created_at`) VALUES
(3, 'basic', 'body', 1, '2023-03-20 01:34:16'),
(4, 'Est aliquid quas ex', 'Amet rerum quia lau', 1, '2023-03-20 02:06:18'),
(5, 'Quis id qui libero c', 'Quia vel magnam magn', 1, '2023-03-20 02:06:26');
...
--
-- Indexes for table `tbannouncements`
--
...
--
-- AUTO_INCREMENT for table `tbannouncements`
--
ALTER TABLE `tbannouncements`
